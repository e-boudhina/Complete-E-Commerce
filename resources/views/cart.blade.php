                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
{{--                                                Custom path since the cart does not know the image unless you tell it that in the controller--}}
                                                <img src="{{asset('uploads/products/'.$product->model->image)}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                            </a>
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{route('cart.decrement', [$product->rowId,$product->qty])}}" class="quantity-minus" onclick="sub">-</a>
